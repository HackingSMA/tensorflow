...
if exist tensorflow\contrib\cmake\build-UWP\ rmdir /s tensorflow\contrib\cmake\build-UWP\

mkdir tensorflow\contrib\cmake\build-UWP
cd tensorflow\contrib\cmake\build-UWP
